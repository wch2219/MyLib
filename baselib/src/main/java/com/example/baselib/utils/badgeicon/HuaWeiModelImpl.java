...
public class HuaWeiModelImpl implements BadgeNumModel {
    ...
    public Notification setIconBadgeNum(@NonNull Application context, Notification notification, int count) throws Exception {
        ...
        bunlde.putString("class", LuncherUtils.getInstance().getLaunchIntentForPackage(context)); // com.test. badge.MainActivity is your apk main activity
