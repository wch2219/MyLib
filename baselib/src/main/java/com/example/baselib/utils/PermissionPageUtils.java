...
public class PermissionPageUtils {
    ...
    private String mess = "跳转失败,请手动前往设置>>权限管理开启权限";
    ...
    private void goLGMainager() {
        try {
            ...
            if (mJumpPagePrPermissDefaut != null) {
                mJumpPagePrPermissDefaut.jumpDefaut(mess);
            }
            e.printStackTrace();
            goIntentSetting();
        }
    ...
    private JumpPagePrPermissDefaut mJumpPagePrPermissDefaut;
    public interface JumpPagePrPermissDefaut{

        void jumpDefaut(String mess);
    }

    public void setJumpPagePrPermissDefaut(JumpPagePrPermissDefaut jumpPagePrPermissDefaut) {
        mJumpPagePrPermissDefaut = jumpPagePrPermissDefaut;
    }
}
