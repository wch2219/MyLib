...
public class GoogleModelImpl implements BadgeNumModel {
    ...
    public Notification setIconBadgeNum(@NonNull Application context, Notification notification, int count) throws Exception {
        ...
        intent.putExtra("badge_count_class_name", LuncherUtils.getInstance().getLaunchIntentForPackage(context)); // com.test. badge.MainActivity is your apk main activity
